...
function FormatItemInfo(itemData, dom) {
  ...
  if (itemData != null && itemData.info != "") {
    if (itemData.name == "id_card") {
      ...
      $(".item-info-title").html("<p>" + itemData.label + "</p>");
      $(".item-info-description").html(
        "<p>capacity(L): " + itemData.info.liter + "</p>"
      );
      ...
      $(".item-info-description").html(
        "<p>" +
          "A kit used to syphon gasoline from vehicles! <br><br>" +
          itemData.info.gasamount +
          " Liters Inside.</p>" +
          '</span></p><p style="padding-top: .8vh;font-size:11px"><b>Weight: </b>' +
      ...
      $(".item-info-description").html(
        "<p>" +
          "A Jerry Can, designed to hold fuel! <br><br>" +
          itemData.info.gasamount +
          " Liters Inside.</p>" +
          '</span></p><p style="padding-top: .8vh;font-size:11px"><b>Weight: </b>' +
          ((itemData.weight * itemData.amount) / 1000).toFixed(1) +
      ...
      $(".item-info-description").html(
        "<p><strong>Citizen ID: </strong><span>" +
          itemData.info.citizenId +
          "</span></p>" +
          "<p><strong>Fine: </strong><span>" +
          itemData.info.fine +
          "</span></p>" +
          "<p><strong>Citation Date: </strong><span>" +
          itemData.info.date +
          "</span></p>" +
          "<p><strong>Incident ID: </strong><span>" +
          itemData.info.incidentId +
          "</span></p>" +
          "<p><strong>Involved Officer: </strong><span>" +
