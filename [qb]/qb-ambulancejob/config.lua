...
Config.ReviveInterval = 5 -- How long the timer is for players to revive a player in laststand
...
Config.BleedTickDamage = 3 -- The base damage that is multiplied by bleed level everytime a bleed tick occurs
...
Config.Locations = { -- Edit the various interaction points for players or create new ones
    ["checking"] = {
	    -- pillbox
        [1] = vector3(307.6, -595.25, 43.0),
	    [2] = vector3(-254.54, 6331.78, 32.43), -- paleto
    },
    ["duty"] = {
        [1] = vector3(312.65, -597.35, 43.0),
        -- [2] = vector3(-254.88, 6324.5, 32.58),
    },
    ["vehicle"] = {
        [1] = vector4(294.578, -574.761, 43.179, 35.79),
        -- pillbox
        [2] = vector4(333.45, -574.89, 28.8, 336.87),
    },
    ["helicopter"] = {
        [1] = vector4(351.58, -587.45, 74.16, 160.5),
        [2] = vector4(-475.43, 5988.353, 31.716, 31.34),
        -- pillbox
        [3] = vector4(352.18, -588.58, 74.16, 21.6),
    },
    ["armory"] = {
        -- pillbox
        [1] = vector3(298.3, -597.8, 43.0),
        -- sandy
        [2] = vector3(1824.88, 3674.66, 34.85),
        -- paleto
        [3] = vector3(-263.54, 6320.59, 32.43),
    },
    ["roof"] = {
    ...
    ["stations"] = {
        [1] = {
            label = Lang:t('info.pb_hospital'), coords = vector4(304.27, -600.33, 43.28, 272.249)
        },
        -- [2] = {
        --     label = Lang:t('The Bay Care Center'), coords = vector4(-242.77, 6324.29, 32.43, 295.76)
        -- },
        -- [3] = {
        --     label = Lang:t('Sandy Shores Medical Center'), coords = vector4(1826.24, 3668.94, 34.28, 205.13)
        -- },
    }
}
