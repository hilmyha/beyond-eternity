local Translations = {
    ...
    nui = {
        respawn_title = "Knocked Out",
        respawn_txt = 'Respawn in:<font color="#f87171"> %{deathtime} </font> seconds',
        respawn_revive =
        'Hold <font color="#f87171"> [E]</font> in <font color="#f87171">(%{holdtime})</font> seconds to respawn for $<font color="yellow"> %{cost} </font> or wait <font color="#f87171">EMS</font>',
        bleed_out_title = "Knocked Out",
        bleed_out = 'You will died in:<font color="#f87171"> %{time} </font> seconds',
        bleed_out_help = 'You will died in:<font color="#f87171"> %{time} </font> seconds',
        getting_helped_title = "Knocked Out",
