                ...
                if not Config.SmallBanks[closestBank]["isOpened"] then
                    ...
                    if hasItem then
                        ...
                        QBCore.Functions.Progressbar("hack_gate", Lang:t("general.connecting_hacking_device"), math.random(5000, 10000), false, true, {
                            ...
                            local success = exports['qb-minigames']:Hacking(10, 60) -- code block size & seconds to solve
                            -- local success = exports['qb-minigames']:StartPinpad(5) -- code block size & seconds to solve
                            if success then
