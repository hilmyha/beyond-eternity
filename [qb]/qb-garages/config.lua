...
Config.Garages = {
    ...
    ['fantasticplazza'] = {
        ['Zone'] = {
            ['Shape'] = {
                vector2(241.62, -1146.88),
                vector2(242.62, -1165.27),
                vector2(267.07, -1165.9),
                vector2(267.63, -1146.71)
            }
        },
        label = 'Fantastic Plazza Parking',
        showBlip = true,
        blipcoords = vector3(259.53, -1156.93, 29.26),
        ...
        debug = false,
        ['ParkingSpots'] = {
            vector4(265.42, -1162.27, 28.63, 359.83),
            vector4(262.47, -1162.37, 28.61, 358.83),
            vector4(259.4, -1162.53, 28.61, 357.21),
            vector4(256.27, -1161.87, 28.61, 359.85),
            vector4(253.25, -1162.26, 28.58, 358.92),
            vector4(249.94, -1162.36, 28.57, 356.4),
            vector4(246.56, -1162.48, 28.59, 357.96),
            vector4(243.36, -1149.87, 28.63, 180.25),
            vector4(246.67, -1149.0, 28.68, 179.72),
            vector4(250.01, -1149.42, 28.71, 179.02),
            vector4(253.34, -1149.18, 28.72, 180.08),
            vector4(256.45, -1148.9, 28.72, 179.7),
            vector4(259.53, -1149.21, 28.72, 178.24),
            vector4(262.48, -1149.64, 28.72, 179.42),
            vector4(265.5, -1149.72, 28.72, 177.92)
        }
    },
    ['pillboxgarage'] = {
        ['Zone'] = {
    ...
    ['southrockforddrive'] = { -- hide
        ['Zone'] = {
            ['Shape'] = {
                vector2(-680.38232421875, -1113.8779296875),
                vector2(-687.41711425781, -1102.9979248047),
                vector2(-689.44256591797, -1104.3253173828),
                vector2(-693.38763427734, -1098.1458740234),
                vector2(-707.28680419922, -1107.1058349609),
                vector2(-702.92388916016, -1113.9417724609),
                vector2(-703.50665283203, -1114.3187255859),
                vector2(-696.75360107422, -1124.7724609375)
            },
            ['minZ'] = 12.53,
            ['maxZ'] = 19.20
        },
        ...
        showBlip = true, -- hide
        blipcoords = vector3(-699.48, -1105.8, 14.53),
        blipName = 'Public Parking',
        blipNumber = 357,
        type = 'public',
        vehicleCategories = { 'car', 'motorcycle', 'other' },
        ...
        debug = false,
        ['ParkingSpots'] = {
            vector4(-693.43, -1102.34, 13.96, 32.66),
            vector4(-696.87, -1104.16, 13.96, 32.88),
            vector4(-700.35, -1106.35, 13.96, 32.71),
            vector4(-703.77, -1108.55, 13.96, 33.14),
            vector4(-696.95, -1121.45, 13.96, 213.75),
            vector4(-694.11, -1119.81, 13.96, 214.44),
            vector4(-691.35, -1117.84, 13.96, 212.5),
            vector4(-688.56, -1116.26, 13.96, 212.68),
            vector4(-686.13, -1114.24, 13.96, 213.31),
            vector4(-683.47, -1112.61, 13.96, 211.45)
        }
    },
    ['casinop'] = {
        ['Zone'] = {
    ...
    ['tuners'] = {
        ['Zone'] = {
            ...
            ['minZ'] = 3.69, -- min height of the parking zone
            ['maxZ'] = 7.69, -- max height of the parking zone
        },
        label = "Tuners Parking",
        showBlip = false,
        blipcoords = vector3(163.87, -2999.82, 5.93),
        blipName = "Public Parking",
        blipNumber = 357,
        type = 'public',      --public, job, gang, depot
        vehicleCategories = { 'car', 'motorcycle', 'other' },
        ...
        debug = false,
        ['ParkingSpots'] = {
            vector4(162.38, -3002.85, 5.55, 267.0),
            vector4(162.47, -3006.05, 5.55, 273.09),
            vector4(162.61, -3009.29, 5.55, 257.54),
            vector4(162.82, -2996.25, 5.54, 275.36),
            vector4(162.62, -2993.31, 5.54, 271.39),
            vector4(162.7, -2990.13, 5.54, 274.27)
        }
    ...
    ['adminbase'] = {
        ['Zone'] = {
            ['Shape'] = { --polygon that surrounds the parking area
                vector2(1398.8983154297, 1113.6600341797),
                vector2(1398.9268798828, 1107.6755371094),
                vector2(1404.2642822266, 1107.63671875),
                vector2(1404.5412597656, 1113.6350097656)
            },
            ['minZ'] = 112.82878112793, -- min height of the parking zone
            ['maxZ'] = 116.82878112793, -- max height of the parking zone
        },
        label = "Admin Base Parking",
        showBlip = false,
        blipcoords = vector3(1401.15, 1109.32, 114.83),
        blipName = "Public Parking",
        blipNumber = 357,
        type = 'public',      --public, job, gang, depot
        vehicleCategories = { 'car', 'motorcycle', 'other' },
        ...
        debug = false,
        ['ParkingSpots'] = {
            vector4(1401.83, 1109.96, 113.83, 0.58)
        }
    },
    -- ['eclipseparking'] = {
    --     ['Zone'] = {
    --         ['Shape'] = {
    --             vector2(-655.67456054688, 359.07611083984),
    --             vector2(-656.62548828125, 346.50372314453),
    --             vector2(-691.10089111328, 348.07061767578),
    --             vector2(-689.84887695312, 362.06405639648)
    --         },
    --         ['minZ'] = 62.12,
    --         ['maxZ'] = 82.934341430664
    --     },
    --     label = "Eclipse Parking",
    --     showBlip = false,
    --     blipcoords = vector3(-654.63, 352.66, 78.12),
    --     blipName = "Public Parking",
    --     blipNumber = 357,
    --     type = 'public',                --public, job, gang, depot
    --     vehicleCategories = {'car', 'motorcycle', 'other'},
    --     drawText = 'Parking',                 --car, air, sea
    --     ['ParkingSpots'] = {
    --         vector4(-657.91, 349.6, 77.48, 176.98),
    --         vector4(-661.43, 350.13, 77.48, 174.41),
    --         vector4(-664.86, 350.42, 77.48, 173.49),
    --         vector4(-668.3, 350.72, 77.48, 172.65),
    --         vector4(-671.57, 350.97, 77.48, 175.49),
    --         vector4(-674.8, 351.25, 77.48, 175.82),
    --         vector4(-678.19, 351.54, 77.48, 174.33),
    --         vector4(-681.73, 351.84, 77.48, 173.76),
    --         vector4(-685.25, 352.18, 77.48, 176.14),
    --         vector4(-688.75, 352.46, 77.48, 174.63),
    --         vector4(-688.46, 358.39, 77.48, 352.58),
    --         vector4(-685.19, 358.13, 77.48, 353.78),
    --         vector4(-681.78, 357.83, 77.48, 353.48),
    --         vector4(-678.38, 357.53, 77.48, 353.67),
    --         vector4(-674.96, 357.23, 77.48, 355.41),
    --         vector4(-671.54, 357.08, 77.49, 354.48),
    --         vector4(-668.16, 356.7, 77.48, 354.87),
    --         vector4(-664.84, 356.38, 77.49, 351.06),
    --         vector4(-661.2, 356.11, 77.48, 354.92),
    --         vector4(-657.66, 355.81, 77.48, 357.65),
    --     },
    --     debug = false
    -- },
    -- ['legionsquare'] = {
    ...
    ['adminheli'] = {
        ['Zone'] = {
            ['Shape'] = { --polygon that surrounds the parking area
                vector2(1488.5311279297, 1060.1257324219),
                vector2(1488.5892333984, 1073.9008789062),
                vector2(1502.2097167969, 1073.9479980469),
                vector2(1502.3114013672, 1060.1423339844)
            },
            ['minZ'] = 114.12, -- min height of the parking zone
            ['maxZ'] = 119.12, -- max height of the parking zone
        },
        label = 'Admin Base Helipad',
        type = 'public',
        vehicleCategories = { 'helicopter' },
        drawText = 'Admin Base Helipad',
        showBlip = true,
        blipName = 'Helipad',
        blipNumber = 64,
        blipColor = 50,
        blipcoords = vector3(1495.4, 1067.46, 116.12),
        ['ParkingSpots'] = {
            vector4(1495.4, 1067.46, 116.0, 92.39),
        },
        ParkingDistance = 10.0,
        debug = false
    },
