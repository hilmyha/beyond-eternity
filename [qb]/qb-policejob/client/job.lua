...
CreateThread(function()
    ...
    local function PoliceVehicle(k)
        CheckVehicle = true
        CreateThread(function()
    ...
    for k, v in pairs(Config.Locations["vehicle"]) do
        local boxZone = BoxZone:Create(vector3(v.x, v.y, v.z), 3, 3, {
            name = 'box_zone',
            debugPoly = true,
            minZ = v.z - 1,
            maxZ = v.z + 1,
        ...
        boxZone:onPlayerInOut(function(isPointInside)
            if isPointInside and PlayerJob.name == "police" and PlayerJob.onduty then
