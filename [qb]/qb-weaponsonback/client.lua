...
local meleelarge = {
    ...
    ["weapon_perforator"] = "w_me_perforator",
}
...
function GiveWeap(wep)
    ...
    if valid then
        ...
        AttachEntityToEntity(weaps[wep], PlayerPedId(), bone, x, y, z, x_rotation, y_rotation, z_rotation, 1, 1, 0, 0, 2,
            1)
    end
end
