...
local Translations = {
    ...
    fuel_order_ready =
    "Ihre Kraftstoffbestellung ist abholbereit! Schauen Sie auf Ihrem GPS nach, um die Abholstelle zu finden!",
    ...
    you_are_discount_eligible = "Wenn Sie im Dienst sind, können Sie einen Rabatt von " ..
    Config.EmergencyServicesDiscount['discount'] .. "% erhalten!",
    ...
    station_reserves_over_max = "Du kannst diesen Betrag nicht kaufen, da er größer ist als der Höchstbetrag von " ..
    ...
    menu_purchase_station_cancel_footer =
    "Ich möchte diesen Standort eigentlich nicht mehr kaufen. Dieser Preis ist verrückt!",
