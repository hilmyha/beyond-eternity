...
local Translations = {
    ...
    fuel_order_ready =
    "Votre commande de carburant est disponible pour récupération ! Consultez votre GPS pour trouver l'endroit de récupération !",
    ...
    you_are_discount_eligible = "Si vous êtes en service, vous pourriez bénéficier d'une réduction de " ..
    ...
    station_reserves_over_max = "Vous ne pouvez pas acheter ce montant car il sera supérieur au montant maximum de " ..
    Config.MaxFuelReserves .. " Litres",
    ...
    syphon_kit_cannot_fit_1 =
    "Vous ne pouvez pas siphonner autant, votre canette n'y rentrera pas ! Vous ne pouvez adapter: ",
